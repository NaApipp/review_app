...
export async function POST(request: Request) {
  try {
    ...
    const collection = db.collection("anotator_review_fashion_user2");
    ...
    console.error("POST /add_review_anotator:", error);
    return NextResponse.json(
      {
...
export async function GET(request: Request) {
  try {
    ...
    console.error("GET /anotator_review_handphone:", error);
