...
export default function LoginForm() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("/api/laptop/auth/login", {
        method: "POST",
      ...
      <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="relative hidden lg:flex flex-col justify-between p-10 bg-gradient-to-br from-[#071c2f] to-[#0c2f4f] text-white">
          ...
          <div>
            ...
            <p className="mt-4 max-w-md text-white/80">
              ...
              <span className="text-[#00F7FF] font-semibold">
                {" "}
                Sector Laptop.
              </span>{" "}
            </p>
        ...
        <div className="flex items-center justify-center px-6">
          <div className="w-full max-w-md">
            {/* Header */}
            <div className="mb-8">
              <h2 className="text-3xl font-bold mt-2">Sector Laptop Login</h2>
