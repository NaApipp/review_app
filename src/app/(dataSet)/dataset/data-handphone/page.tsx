...
export default function ClientView() {
  ...
  useEffect(() => {
    const fetchDataset = async () => {
      try {
        setLoading(true);
        const response = await fetch("/api/dataset/data-handphone");
        ...
        setAduanList(sortedData);
          ...
          setError(json.message || "Gagal mengambil dataset handphone");
        }
      } catch (error) {
        console.error("Error fetching dataset handphone:", error);
