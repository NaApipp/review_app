...
export default function ClientView() {
  ...
  useEffect(() => {
    const fetchDataset = async () => {
      try {
        setLoading(true);
        const response = await fetch("/api/dataset/data-laptop");
        ...
        setAduanList(sortedData);
          ...
          setError(json.message || "Gagal mengambil dataset laptop");
        }
      } catch (error) {
        console.error("Error fetching dataset laptop:", error);
