...
export default function LoginForm() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    // Fetech API login
    try {
      const res = await fetch("/api/anotator-user2/anotator-laptop/auth/login", {
        method: "POST",
      ...
      router.replace("/label-review-laptop-v2");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    ...
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="relative hidden lg:flex flex-col justify-between p-10 bg-gradient-to-br from-[#071c2f] to-[#0c2f4f] text-white">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold text-lg">Portal Login For User V2</span>
          </div>
          ...
          <div>
            ...
            <p className="mt-4 max-w-md text-white/80">
              ...
              <span className="text-[#00F7FF] font-semibold"> Sector Laptop.</span>{" "}
            </p>
          </div>
          ...
          <div className="w-full max-w-md">
            ...
            <div className="mb-8">
              <h2 className="text-3xl font-bold mt-2">Anotator Portal Login <br />
               <span className="text-[#00F7FF] font-semibold">Sector Laptop V2</span>
              </h2>
            </div>
    ...
    //           Anotator <span className="text-[#00F7FF]">Laptop</span> <br /> Portal Login
    //         </h2>
