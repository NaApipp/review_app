      ...
      <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex items-center justify-center px-6 bg-gradient-to-br from-[#0F2854] to-[#1C4D8D]">
          <div className="w-full max-w-md">
            ...
            <Link href={"/handphone-sector"} className="md:hidden flex flex-row w-max rounded-2xl items-center p-2 text-sm text-white/70 bg-blue-500 hover:bg-blue-600 transition-colors mt-3">
            <svg
              className="w-8 h-8 text-white dark:text-white"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
